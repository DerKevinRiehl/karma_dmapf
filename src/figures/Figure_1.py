...
df_neg_alt2 = load_data(
    grid_size="5",
    controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC2",
    measure=row_measures[0],
)
controller_dfs_5_rw1 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
# df_respect = load_data(
...
#     measure=row_measures[0],
# )
# controller_dfs_10_rw1 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
...
controller_dfs_5_rw2 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
# df_respect = load_data(
...
#     measure=row_measures[1],
# )
# controller_dfs_10_rw2 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
...
controller_dfs_5_rw3 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
# df_respect = load_data(
...
#     measure=row_measures[2],
# )
# controller_dfs_10_rw3 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
...
controller_dfs_5_rw4 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
# df_respect = load_data(
...
#     measure=row_measures[3],
# )
# controller_dfs_10_rw4 = [df_respect, df_neg_ego, df_neg_alt, df_neg_alt2]
...
plt.subplots_adjust(top=0.960, bottom=0.060, left=0.050, right=0.990, hspace=0.250, wspace=0.230)
