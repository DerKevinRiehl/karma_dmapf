...
df_respect = load_data(grid_size="5", controller="DECENTRALIZED_RESPECT", measure=row_measures[0])
df_neg_alt = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[0])
df_neg_ego = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[0])
controller_dfs_5_rw1 = [df_respect, df_neg_alt, df_neg_ego]
df_respect = load_data(grid_size="10", controller="DECENTRALIZED_RESPECT", measure=row_measures[0])
df_neg_alt = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[0])
df_neg_ego = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[0])
controller_dfs_10_rw1 = [df_respect, df_neg_alt, df_neg_ego]

df_respect = load_data(grid_size="5", controller="DECENTRALIZED_RESPECT", measure=row_measures[1])
df_neg_alt = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[1])
df_neg_ego = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[1])
controller_dfs_5_rw2 = [df_respect, df_neg_alt, df_neg_ego]
df_respect = load_data(grid_size="10", controller="DECENTRALIZED_RESPECT", measure=row_measures[1])
df_neg_alt = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[1])
df_neg_ego = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[1])
controller_dfs_10_rw2 = [df_respect, df_neg_alt, df_neg_ego]

df_respect = load_data(grid_size="5", controller="DECENTRALIZED_RESPECT", measure=row_measures[2])
df_neg_alt = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[2])
df_neg_ego = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[2])
controller_dfs_5_rw3 = [df_respect, df_neg_alt, df_neg_ego]
df_respect = load_data(grid_size="10", controller="DECENTRALIZED_RESPECT", measure=row_measures[2])
df_neg_alt = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[2])
df_neg_ego = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[2])
controller_dfs_10_rw3 = [df_respect, df_neg_alt, df_neg_ego]

df_respect = load_data(grid_size="5", controller="DECENTRALIZED_RESPECT", measure=row_measures[3])
df_neg_alt = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[3])
df_neg_ego = load_data(grid_size="5", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[3])
controller_dfs_5_rw4 = [df_respect, df_neg_alt, df_neg_ego]
df_respect = load_data(grid_size="10", controller="DECENTRALIZED_RESPECT", measure=row_measures[3])
df_neg_alt = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_ALTRUISTIC", measure=row_measures[3])
df_neg_ego = load_data(grid_size="10", controller="DECENTRALIZED_NEGOTIATE_EGOISTIC", measure=row_measures[3])
