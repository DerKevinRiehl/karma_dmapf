...
class GridTools:        
    def create_dynamic_occupancy_grid(environment, time_horizon, agent_list=None, tabu_agent=None):
        reservation_grid = GridTools.create_3D_reservation_grid(environment, time_horizon, agent_list, tabu_agent)
        dynamic_occupancy = reservation_grid != 0
        return dynamic_occupancy
    
    def create_3D_reservation_grid(environment, time_horizon, agent_list=None, tabu_agent=None):
        reservation_table = np.zeros((time_horizon+1, environment.grid.grid_size, environment.grid.grid_size))
